...
# This script is based on https://raw.githubusercontent.com/laminas/documentation-theme/master/build.sh
#
...
if [ -e .shareforce-mkdoc-theme-preserve ]; then
    mkdir .preserve
    for PRESERVE in $(cat .shareforce-mkdoc-theme-preserve); do
